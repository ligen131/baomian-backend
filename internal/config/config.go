...
func Load() (Config, error) {
	...
	cfg := Config{
		...
		AIProvider:                  strings.ToLower(env("AI_PROVIDER", "openai_compatible")),
		AnthropicAPIKey:             strings.TrimSpace(os.Getenv("ANTHROPIC_API_KEY")),
		AnthropicAuthToken:          strings.TrimSpace(os.Getenv("ANTHROPIC_AUTH_TOKEN")),
		AnthropicBaseURL:            strings.TrimRight(env("ANTHROPIC_BASE_URL", "http://127.0.0.1:38109"), "/"),
		AnthropicModel:              env("ANTHROPIC_MODEL", "deepseek-v4-flash"),
